<template>
  <div class="box">
    ...
    <a class="game-item" target="_blank" rel="nofollow external" href="https://edition.cnn.com/interactive/2021/03/cnnix-steership/">
    ...
    <a class="game-item" target="_blank" rel="nofollow external" href="https://www.yikm.net/">
    ...
    <a class="game-item" target="_blank" rel="nofollow external" href="https://2020game.io/">
      <img src="/icons/11.png" alt="" class="game-logo">
      <div class="game-info">
    ...
    <a class="game-item" target="_blank" rel="nofollow external" href="https://lines.frvr.com/">
      <img src="/icons/13.png" alt="" class="game-logo">
      <div class="game-info">
    ...
    <a class="game-item" target="_blank" rel="nofollow external" href="http://www.heyzxz.me/pcol/">
      <img src="/icons/14.png" alt="" class="game-logo">
      <div class="game-info">
        <div class="game-title">沉浸式3D台球</div>
        <div class="game-desc">在线台球游戏，画质很精美</div>
      </div>
    </a>
    <a class="game-item" target="_blank" rel="nofollow external" href="https://beta.deeeep.io/?host=BPIx93">
