...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/index-5f1dba05.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/index-e09ae6b7.js").then((m) => m.default || m)
  },
  {
    name: "tools",
    path: "/tools",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/index-be7ead22.js").then((m) => m.default || m)
  },
  {
    name: "tools-tools",
    path: "/tools/tools",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/tools-53bb13c3.js").then((m) => m.default || m)
  }
];
