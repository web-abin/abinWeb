...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/index-5332c403.js").then((m) => m.default || m)
  },
  {
    name: "tools",
    path: "/tools",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/index-d492b72b.js").then((m) => m.default || m)
  },
  {
    name: "tools-tools",
    path: "/tools/tools",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/tools-31ad81d6.js").then((m) => m.default || m)
  }
];
