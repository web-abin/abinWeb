...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/index-3d88d8a6.js").then((m) => m.default || m)
  },
  {
    name: "tools",
    path: "/tools",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/index-46c667d1.js").then((m) => m.default || m)
  },
  {
    name: "tools-tools",
    path: "/tools/tools",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/tools-b1e88918.js").then((m) => m.default || m)
  }
];
