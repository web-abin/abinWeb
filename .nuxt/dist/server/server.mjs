...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/index-894b93e0.js").then((m) => m.default || m)
  },
  {
    name: "tools",
    path: "/tools",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/index-a3cf8025.js").then((m) => m.default || m)
  },
  {
    name: "tools-tools",
    path: "/tools/tools",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/tools-dfc74830.js").then((m) => m.default || m)
  }
];
