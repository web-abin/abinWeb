...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/index-3dc902a0.js").then((m) => m.default || m)
  },
  {
    name: "tools",
    path: "/tools",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/index-d2c55f0f.js").then((m) => m.default || m)
  },
  {
    name: "tools-tools",
    path: "/tools/tools",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./static/tools-54e4fc12.js").then((m) => m.default || m)
  }
];
