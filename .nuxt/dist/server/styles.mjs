...
export default {
  ...
  "pages/games/index.vue": () => import('./static/index-styles.f3ac6dd4.mjs').then(interopDefault),
  ...
  "pages/relax/index.vue": () => import('./static/index-styles.305e536f.mjs').then(interopDefault),
