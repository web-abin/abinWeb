...
export default {
  ...
  "pages/relax/index.vue": () => import('./static/index-styles.6aaa0a5b.mjs').then(interopDefault),
  ...
  "pages/index.vue": () => import('./static/index-styles.9cb240b2.mjs').then(interopDefault),
