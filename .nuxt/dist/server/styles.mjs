...
export default {
  ...
  "pages/games/index.vue": () => import('./static/index-styles.ba1a70d2.mjs').then(interopDefault),
  ...
  "pages/relax/index.vue": () => import('./static/index-styles.39a45455.mjs').then(interopDefault),
