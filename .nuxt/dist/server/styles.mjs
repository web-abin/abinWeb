...
export default {
  ...
  "pages/relax/index.vue": () => import('./static/index-styles.84828f6a.mjs').then(interopDefault),
  "pages/games/index.vue": () => import('./static/index-styles.b532b07f.mjs').then(interopDefault),
