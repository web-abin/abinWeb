...
export default {
  ...
  "pages/notes/index.vue": () => import('./static/index-styles.a6d884f5.mjs').then(interopDefault),
  "pages/relax/index.vue": () => import('./static/index-styles.85d1d0e2.mjs').then(interopDefault),
