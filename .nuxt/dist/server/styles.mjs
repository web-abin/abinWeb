...
export default {
  ...
  "pages/notes/index.vue": () => import('./static/index-styles.10bb13be.mjs').then(interopDefault),
  ...
  "pages/relax/index.vue": () => import('./static/index-styles.0190cbd0.mjs').then(interopDefault),
