...
export default {
  ...
  "pages/notes/index.vue": () => import('./static/index-styles.7a1956d7.mjs').then(interopDefault),
  "pages/relax/index.vue": () => import('./static/index-styles.33332eee.mjs').then(interopDefault),
