...
export default {
  ...
  "pages/notes/index.vue": () => import('./static/index-styles.43fd5132.mjs').then(interopDefault),
  "pages/tools/index.vue": () => import('./static/index-styles.96e7b536.mjs').then(interopDefault),
  "pages/relax/index.vue": () => import('./static/index-styles.04f27b2b.mjs').then(interopDefault),
