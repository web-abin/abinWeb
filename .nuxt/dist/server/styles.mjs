...
export default {
  ...
  "pages/notes/index.vue": () => import('./static/index-styles.d4c2d942.mjs').then(interopDefault),
  "pages/relax/components/fish.vue": () => import('./static/fish-styles.daadeec2.mjs').then(interopDefault),
  "pages/relax/index.vue": () => import('./static/index-styles.ed566bc8.mjs').then(interopDefault),
