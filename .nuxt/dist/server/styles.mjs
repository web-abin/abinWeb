...
export default {
  ...
  "pages/relax/index.vue": () => import('./static/index-styles.18b43bbb.mjs').then(interopDefault),
  "pages/notes/index.vue": () => import('./static/index-styles.83483d62.mjs').then(interopDefault),
